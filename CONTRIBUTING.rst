...
Report bugs at https://github.com/apiology/cookiecutter-docker-image/issues
...
Cookiecutter Docker image could always use more documentation, whether as part of
the official Cookiecutter Docker image docs, in docstrings, or even on the web in blog posts, articles,
and such.
...
https://github.com/apiology/cookiecutter-docker-image/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-docker-image` for local
development. Please note this documentation assumes you already have
`virtualenv` and `Git` installed and ready to go.

1. Fork the `cookiecutter-docker-image` repo on GitHub.
...
2. Clone your fork locally:
   ...
   .. code-block:: bash
    ...
    $ git clone git@github.com:YOUR_NAME/cookiecutter-docker-image.git
...
3. You can create a new environment for your local development by typing:
   ...
   .. code-block:: bash
        ...
        $ virtualenv cookiecutter-docker-image-env
        $ source cookiecutter-docker-image-env/bin/activate

   This should change the shell to look something like:

   .. code-block:: bash

        (cookiecutter-docker-image-env) $
...
6. The next step would be to run the test cases. `cookiecutter-docker-image` uses
...
3. The pull request should work for Python 3.7, 3.8, 3.9 and 3.10. Check
   https://app.circleci.com/pipelines/github/apiology/cookiecutter-docker-image and
...
.. cookiecutter: https://github.com/apiology/cookiecutter-docker-image
