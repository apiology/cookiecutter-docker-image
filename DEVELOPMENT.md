...
See [docs/SYNCING_BOILERPLATE.md](docs/SYNCING_BOILERPLATE.md). Interpret hierarchy at **this** tier (`cookiecutter-docker-image`, Docker image) using `.cursor/rules/template-hierarchy.mdc` when present.
